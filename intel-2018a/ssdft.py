...
class EB_SSDFT(ConfigureMake):
    ...
    def configure_step(self):
        ...
        adjust_permissions(os.path.join(start_dir, 'obj_setup_dmf.sh'), stat.S_IXUSR, recursive=False, relative=True)
        run_cmd(os.path.join(start_dir, 'obj_setup_dmf.sh'), log_all=True, simple=True, log_output=True)
